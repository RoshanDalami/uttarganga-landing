      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300">
            Comprehensive solutions for sustainable hydroelectric energy
            development
          </p>
        </div>
      </motion.section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Development and operation of state-of-the-art hydroelectric
                power generation facilities utilizing Nepal&apos;s abundant
                water resources. Our projects are designed to provide reliable,
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Comprehensive project development services from feasibility
                studies to commissioning. We manage all aspects of hydropower
                project development with expertise and efficiency.
              </p>
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Commitment to environmental sustainability through comprehensive
                assessment and management practices. We ensure all projects meet
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Active engagement with local communities through various
                development programs and initiatives. We believe in creating
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Expert advisory services for hydropower project development,
                drawing from our extensive experience in the field. We provide
            ...
            <div className="bg-white border border-gray-200 p-8">
              ...
              <p className="text-gray-700 mb-4">
                Attractive investment opportunities in sustainable energy
                infrastructure. Our projects offer long-term returns while
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-700 text-white p-12 rounded text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Contact us to learn more about how we can help with your
              hydropower needs
            </p>
            <Link
              href="/contact"
